		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="sm:max-w-lg">
				<DialogHeader>
					...
					<DialogDescription>
						分享 &ldquo;{documentTitle}&rdquo; 给其他人访问
					</DialogDescription>
				</DialogHeader>
				...
				{isLoading ? (
					...
					<div className="space-y-5 py-2">
						...
						<div className="space-y-2">
							<Label htmlFor="expires-select" className="text-base">有效期</Label>
							<Select
								value={expiresType}
								onValueChange={setExpiresType}
							>
						...
						<div className="space-y-3">
							<div className="flex items-center justify-between">
								<Label htmlFor="use-password" className="text-base">访问密码</Label>
								<Switch
									id="use-password"
									checked={usePassword}
