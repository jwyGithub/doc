				...
				<div className="flex-1 overflow-y-auto space-y-6 py-4 pr-2">
					<div className="space-y-2">
						...
						<p className="text-xs text-muted-foreground">
							从 <a href="https://aistudio.google.com/apikey" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Google AI Studio</a> 获取 API Key
							{apiKeyConfigured && <span className="text-green-600 ml-2">（已配置）</span>}
						</p>
					</div>
					...
					<div className="space-y-2">
						...
						<p className="text-xs text-muted-foreground">
							推荐模型：gemini-2.5-flash（快速）、gemini-2.5-pro（高质量）
						</p>
					</div>
